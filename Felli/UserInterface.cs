...
namespace Felli
{
    ...
    public class UserInterface
    {
        ...
        public void Intro()
        {
            ...
            Console.WriteLine("||                                          ||");
            Console.WriteLine("||  - The board has 13 playable positions,  ||");
            Console.WriteLine("||    they start in the top left and are    ||");
            Console.WriteLine("||    organized top/down and left/right.    ||");
            Console.WriteLine("||  - To choose a position, you must        ||");
            Console.WriteLine("||    type in a number in-between 1 and 13. ||");
            Console.WriteLine("||                                          ||");
            Console.WriteLine("||  Turns:                                  ||");
            Console.WriteLine("||                                          ||");
            Console.WriteLine("||  - The player must first pick which      ||");
            Console.WriteLine("||    piece he wants to grab (1-13).        ||");
            Console.WriteLine("||  - If its a valid one, he can then       ||");
            Console.WriteLine("||    choose where to move it (1-13).       ||");
            Console.WriteLine("||                                          ||");
